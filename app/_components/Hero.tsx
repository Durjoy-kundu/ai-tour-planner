...
const suggetions = [
    ...
    {
        title:'Discover Hidden gems',
        icon: <Landmark className='text-Black-500 h-5 w-5'/>
    },
    ...
    <div className='mt-24  w-full flex justify-center'>
     ...
     <div className='max-w-3xl w-full text-center space-y-6'>
        <h1 className='text-xl md:text-5xl font-bold'>
            Hey, I am your AI <span className='text-primary'>Travel Planner</span>
        </h1>
        ...
        <div className='flex gap-5'>
            {suggetions.map((suggestion, index) => (
                <div key={index} className='flex items-center gap-2 boreder rounded-full p-2 cursor-pointer hover:bg-primary hover:text-white '>
                    {suggestion.icon}
        ...
        <div className='flex items-center justify-center flex-col'>
             {/*Video section */}
        <h2 className='my-7 mt-14 gap-2 flex text-center'>Not Sure where to start? <strong>See how it works</strong><ArrowBigDown/></h2>
         <HeroVideoDialog

...
const PlaceCardItem = ({activity}: Props) => {
  return (
    <div  className='border-b border-gray-200 py-2'>
                  <Image src={'/trvel.svg'} alt={activity.place_name} width={400} height={200} className='rounded-xl shadow object-cover mb-2'/>
                  ...
                  <p className='flex text-orange-700 gap-2'><Clock/> Best Time: {activity?.best_time_to_visit}</p>
                  <a
